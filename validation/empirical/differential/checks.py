...
check(
    id="simpleFst-is-nei",
    fqn="Descent.PopulationGeneticsFoundations.neiGstFromFrequencies",
...
check(
    ...
    fqn="Descent.Conventions.hudsonFst",
...
check(
    id="neiFst-identity",
    fqn="Descent.PopulationGeneticsFoundations.neiFst",
...
check(
    ...
    fqn="Descent.PopulationGeneticsFoundations.coalFst",
...
check(
    ...
    fqn="Descent.PopulationGeneticsFoundations.heterozygosityLossDerived",
...
check(
    ...
    fqn="Descent.PopulationGeneticsFoundations.heterozygosityLossFromDrift",
...
check(
    ...
    fqn="Descent.PortabilityDrift.fstFromGenerations",
...
check(
    ...
    fqn="Descent.PortabilityDrift.pairwiseFstFromBranches",
...
check(
    ...
    fqn="Descent.PopulationGeneticsFoundations.expectedHeterozygosity",
...
check(
    ...
    fqn="Descent.PopulationGeneticsFoundations.hetDecayFactor",
...
check(
    ...
    fqn="Descent.PopulationGeneticsFoundations.hetMutationDriftRecurrence",
...
check(
    ...
    fqn="Descent.PopulationGeneticsFoundations.fstMutationDriftTransientDiscrete",
    ...
    reference="Descent.PopulationGeneticsFoundations.fstMutationDriftTransient",
...
check(
    ...
    fqn="Descent.fstMigrationDriftEquilibrium",
...
check(
    ...
    fqn="Descent.PopulationGeneticsFoundations.islandFstFiniteDemes",
...
check(
    ...
    fqn="Descent.PortabilityDrift.fstIslandMultiplicativeEquilibrium",
...
check(
    ...
    fqn="Descent.PopulationGeneticsFoundations.steppingStoneCharacteristicLength",
...
check(
    ...
    fqn="Descent.DemographicHistory.steppingStoneMeetingTimeOnLattice",
...
check(
    ...
    fqn="Descent.DemographicHistory.demoSteppingStoneFst",
...
check(
    ...
    fqn="Descent.DemographicHistory.steppingStoneDiffusionTimescale",
...
check(
    ...
    fqn="Descent.LDDecayTheory.ldRetentionPerGen",
...
check(
    ...
    fqn="Descent.LDDecayTheory.ldHalfLife",
...
check(
    ...
    fqn="Descent.LDDecayTheory.ldRetainedFraction",
    ...
    reference="Descent.LDDecayTheory.ldRetentionPerGen ** t",
...
check(
    ...
    fqn="Descent.LDDecayTheory.driftLDEquilibrium",
...
check(
    ...
    fqn="Descent.ohtaKimuraSigmaDSq",
...
check(
    ...
    fqn="Descent.LDDecayTheory.driftLDTrajectory",
...
check(
    ...
    fqn="Descent.PopulationGeneticsFoundations.selectionMigrationEquilibrium",
...
check(
    ...
    fqn="Descent.PopulationGeneticsFoundations.alleleFreqAfterMigration",
...
check(
    ...
    fqn="Descent.DemographicHistory.admixedFst",
...
check(
    ...
    fqn="Descent.PortabilityDrift.admixtureLDDecay",
...
check(
    ...
    fqn="Descent.PortabilityDrift.pairwiseFstFromBranchTaus",
...
check(
    ...
    fqn="Descent.PortabilityDrift.targetHetFromFst",
...
# DELETED from Descent.PortabilityDrift as falsified -- the reference starts
...
#
# The instrument said so first.  Descent.DriftRegime.symmetric_design_has_no_power
...
check(
    ...
    fqn="Descent.PopulationGeneticsFoundations.wrightFIT",
...
check(
    ...
    reference="Descent.ldRetentionPerGen ** t",
...
check(
    ...
    fqn="Descent.heterozygosityLossVariableNe",
...
check(
    ...
    reference="Descent.harmonicMeanNe substituted into the exponential form",
    grid=[{"nes": _BOTTLENECK}, {"nes": _RAMP}, {"nes": _MILD}, {"nes": _SEVERE}],
    lean=lambda D, nes: D["heterozygosityLossVariableNe"](nes),
...
check(
    ...
    fqn="Descent.ldMismatchFrobenius",
...
check(
    ...
    fqn="Descent.PortabilityDrift.ibdRecurrenceFixedPoint",
...
check(
    ...
    fqn="Descent.PortabilityDrift.ibdFlowStep",
    ...
    reference="Descent.PortabilityDrift.ibdRecurrenceFixedPoint",
    grid=_IBD,
...
check(
    ...
    fqn="Descent.PortabilityDrift.fstMigDriftNext",
    ...
    reference="Descent.PortabilityDrift.ibdFlowStep",
...
check(
    ...
    fqn="Descent.PopulationGeneticsFoundations.scaledIdentityStep",
    ...
    reference="Descent.PortabilityDrift.ibdFlowStep, iterated",
    grid=_IBD,
...
check(
    ...
    fqn="Descent.explainedR2FromTransportMoments",
...
check(
    ...
    fqn="Descent.demographicCovarianceGapLowerBound",
...
check(
    ...
    fqn="Descent.alleleFreqMismatchPenalty",
...
check(
    ...
    fqn="Descent.gaussianPairSquareChannel3",
...
check(
    ...
    fqn="Descent.AncestrySpecificArchitecture.driftVariance",
...
check(
    ...
    fqn="Descent.AncestrySpecificArchitecture.twoPopDriftVariance",
...
check(
    ...
    fqn="Descent.AncestrySpecificArchitecture.expectedFreqDiffSq",
...
_scale_check(
    ...
    "Descent.DemographicHistory.demoSteppingStoneFst",
...
_scale_check(
    ...
    "Descent.DemographicHistory.steppingStoneFstQuadratic",
...
_scale_check(
    ...
    "Descent.AssortativeMatingPGS.ibdFst",
...
check(
    ...
    fqn="Descent.amCorrectedPortability",
    claim=(
...
check(
    ...
    fqn="Descent.nextFloorFourthMoment",
    claim=(
