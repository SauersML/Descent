...
def _find_repo(start):
    ...
    `validation/empirical/differential/cluster/`. The tree was then reorganised
...
def main(argv=None):
    ...
    ap.add_argument("--results-dir", default=None,
                    help="directory holding the study CSVs that parts B and C "
                         "read (env DESCENT_RESULTS_DIR). Default is derived "
    ...
    global RES
    override = args.results_dir or os.environ.get("DESCENT_RESULTS_DIR")
    if override:
