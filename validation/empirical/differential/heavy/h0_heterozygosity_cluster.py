...
are all exact functions of the single number (1 - 1/(2 Ne))^t:
    ...
    Descent.hetRecurrence                  PopulationGeneticsFoundations.lean:1186   ROOT
    Descent.heterozygosityLossDerived                     PopulationGeneticsFoundations.lean:1212
    Descent.heterozygosityLossFromDrift    PopulationGeneticsFoundations.lean:454
    Descent.wrightFisherDriftRetention     PortabilityDrift.lean:710
    Descent.wrightFisherHeterozygosityLoss PortabilityDrift.lean:730
    Descent.cumulativeDrift                DemographicHistory.lean:506    (vector form)
    Descent.heterozygosityLossVariableNe                  DemographicHistory.lean:510    (vector form)
    Descent.targetHetFromFst               PortabilityDrift.lean:653      (consumer)
...
CONTROL 2 -- EQUILIBRIUM LEVEL.  With mu > 0, the stationary heterozygosity
    ...
    (Kimura & Crow 1964; it is also `Descent.hetEquilibrium`, and the
...
def main():
    ...
    summary = {
        ...
        "controls_pinned_by": [
            ...
            "Kimura & Crow 1964 theta/(1+theta) == Descent.hetEquilibrium",
        ],
        "control_2_detail": [
