"""Extract Lean definitions from Descent into a machine-readable table.

Standalone fallback extractor: the `extract` agent is building a richer table
under validation/empirical/extract/.  This module produces the subset that the
...
CAL = pathlib.Path(__file__).resolve().parents[3] / "Descent"
