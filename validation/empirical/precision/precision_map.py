...
catastrophic cancellation silently.
    ...
    python3 validation/empirical/precision/precision_map.py
    python3 validation/empirical/precision/precision_map.py --map
...
CANDIDATES = [
    ("Descent.neiGst",
     ...
     ("Descent.neiGstFromFrequencies", _nei_stable)),

    ("Descent.ldKernelSymbol",
    ...
    ("Descent.fourthCumulantFromMoments",
...
KNOWN_FAILURES = {
    "Descent.neiGst": "1 - H_S/H_T cancels as p1 -> p2; the docstring warning "
                         "on the definition and the DOMAIN note on "
                         "refs.fst_nei_gst both cite this measurement.",
    "Descent.ldKernelSymbol": "Poisson divisor rounds to exactly zero near "
                                 "the singularity; ldKernelSymbol_eq_halfAngle "
                                 "is the stable evaluation.",
    "Descent.bernoulliKLReal": "the body AS WRITTEN loses everything as p -> q. "
    ...
    "Descent.myopiaPrice": "1 - exp(-lam*tau) at short horizons; expm1 fixes "
