...
def Descent_fstEquilibrium(p):
    return _rt.rdiv(1.0, (((1.0 + Descent_EvolutionaryParameters_theta(p)) + (2.0 * Descent_EvolutionaryParameters_bigM(p)))))
...
def Descent_CrossPopulationCalibrationShiftModel_observedMean(m, P):
    return (_rt._proj(m, 'baseObservedMean') + pair(0.0, Descent_CrossPopulationCalibrationShiftModel_observedMeanShift(m), P))
...
def Descent_CrossPopulationMechanisticCalibrationModel_observedMean(m, P):
    return (_rt._proj(m, 'baseObservedMean') + pair(0.0, Descent_CrossPopulationMechanisticCalibrationModel_observedMeanShift(m), P))
...
def Descent_GenerationalPopGenParameters_bigM(g):
    return scaledMigrationRate(_rt._proj(g, 'Ne'), _rt._proj(g, 'mig'))

def tauAt(g, t):
    return _rt.rdiv((t), ((2.0 * _rt._proj(g, 'Ne'))))

def Descent_GenerationalPopGenParameters_hetDecayFactor(g):
    return hetDecayFromScaled(_rt._proj(g, 'Ne'), Descent_GenerationalPopGenParameters_theta(g))

def fstTransientAt(g, t):
    return ((_rt.rdiv(1.0, (((1.0 + Descent_GenerationalPopGenParameters_theta(g)) + (2.0 * Descent_GenerationalPopGenParameters_bigM(g)))))) * ((1.0 - _rt.lpow(fstTransientDecayFromScaled(_rt._proj(g, 'Ne'), Descent_GenerationalPopGenParameters_theta(g), Descent_GenerationalPopGenParameters_bigM(g)), t))))

def mutationSharedRetentionAt(g, t):
    return _rt.rexp((((-Descent_GenerationalPopGenParameters_theta(g)) * tauAt(g, t))))

def migrationSharedBoostAt(g, t):
    return (1.0 + _rt.rdiv((Descent_GenerationalPopGenParameters_bigM(g) * tauAt(g, t)), ((1.0 + Descent_GenerationalPopGenParameters_bigM(g)))))
