...
# REGENERATE WITH:  python3 validation/empirical/extract/ceiling.py
#
# This produces ceiling.json, which are NOT IN GIT.
# They are generated from Descent/, which changes every few
...
def main():
    ...
    for name, d in table.items():
        ...
        for m in IDENT.finditer(text):
            ...
            # `Descent.berryEsseenErrorBound` may sort first.
            #
