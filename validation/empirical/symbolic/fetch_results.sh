...
#
#   bash validation/empirical/symbolic/fetch_results.sh
#
...
$RELAY "cd /projects/standard/hsiehph/sauer354/gnomon && git rev-parse --short HEAD && cd validation/symbolic && module load python3/3.10.9_anaconda2023.03_libmamba >/dev/null 2>&1 && python3 provenance.py"
