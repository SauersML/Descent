...
"""Metamorphic gate: evaluate every declared relation on a FIXED input grid.
    ...
    python3 validation/empirical/metamorphic/run.py
    python3 validation/empirical/metamorphic/run.py --coverage
...
WHAT IT CONSUMES.  `extract/api.py`, the single parse of Descent/ that
