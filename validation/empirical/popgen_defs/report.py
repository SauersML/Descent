...
def main(path):
    ...
    print("         the `fstDrift` column is RETIRED: `Descent.fstFromDrift` is")
    ...
    print("         RETIRED: `Descent.islandModelFst` is no longer in the corpus.")
    print("=" * 78)
    ...
    print("         RETIRED: `Descent.singletonProportion` is not in the corpus.")
    print("=" * 78)
