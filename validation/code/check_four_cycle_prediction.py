...
source = "validation/code/CheckFourCyclePrediction.lean"
shutil.copyfile(str(shared / "CheckFourCyclePrediction.lean"), str(project / source))
env = dict(os.environ)
...
(shared / "four-cycle-prediction-check.log").write_bytes(r.stdout)
