...
`Descent.PopGen.LDDecayTheory`, the one per-generation drift rate, and this file
imports it.
...
`Descent.PopGen.LDDecayTheory`, which this module imports.  It was stated again here as
