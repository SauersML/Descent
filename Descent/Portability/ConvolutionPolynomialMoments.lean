...
/-!
Integer moments of the actual convolution of two probability measures are the
binomial sums of their moments. Integrability of the convolution powers is
...
namespace Descent.Portability.ConvolutionPolynomialMoments

open scoped BigOperators MeasureTheory
open MeasureTheory

/-- Every term of the binomial expansion is integrable on the independent product law. -/
theorem add_power_integrable (μ ν : ProbabilityMeasure ℝ)
    (hμ : ∀ n : ℕ, Integrable (fun x : ℝ ↦ x ^ n) (μ : Measure ℝ))
    (hν : ∀ n : ℕ, Integrable (fun x : ℝ ↦ x ^ n) (ν : Measure ℝ)) (n : ℕ) :
...
end Descent.Portability.ConvolutionPolynomialMoments
