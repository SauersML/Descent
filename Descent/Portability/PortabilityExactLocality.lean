...
/-!
# Exact locality of neutral portability
...
Significance. The report of a score on `A` is exactly local: under neutrality only the linkage
disequilibrium among the panel loci of `A` matters. Mutation rates, crossover structure
...
namespace Descent.Portability.PortabilityExactLocality
...
end Descent.Portability.PortabilityExactLocality
