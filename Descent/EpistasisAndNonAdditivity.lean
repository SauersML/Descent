...
apparatus of `Descent.ScoreDistribution` describes additive aggregates.

`Descent.PolygenicSpectroscopy` computes, in closed form, the allele-frequency-dependent
