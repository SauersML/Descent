...
-/
import Descent.BundleRigidity
import Descent.BundleRigidity.CoverageInvariance
import Descent.BundleRigidity.EntropySplit
import Descent.BundleRigidity.Freshness
...
than `n^α` (see `Descent.CountingInvariantBlindness`).
