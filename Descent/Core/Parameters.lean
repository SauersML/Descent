...
laws in two modules that do not import each other, both called "equilibrium `F_ST`", with nothing
relating them -- and the free-looking `2` in `1/(1 + θ + 2M)` turns out not to be
