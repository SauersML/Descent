...
* **The `m_eff` prohibition** (`Descent.ImitationCapacity`, proved and simulated): no
...
In `Descent.ImitationCapacity` the two spectra do not share their moments exactly; they
