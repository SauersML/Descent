...
`Descent.FoldedSpectrum` does the rest: the whole collinear family shares its two
...
`Descent.LatentMechanismCollapse` proves the finite shadow of the collapse theorem --
